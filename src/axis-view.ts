...
import { Point, DrawingToolsDataSource } from './data-source';

abstract class DrawingToolsAxisView implements ISeriesPrimitiveAxisView {
	_source: DrawingToolsDataSource;
	_p: Point;
	_pos: Coordinate | null = null;
	constructor(source: DrawingToolsDataSource, p: Point) {
		this._source = source;
		this._p = p;
	}
...
export class DrawingToolsTimeAxisView extends DrawingToolsAxisView {
	update() {
...
export class DrawingToolsPriceAxisView extends DrawingToolsAxisView {
	update() {
